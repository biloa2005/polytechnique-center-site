...
import { BookOpen, Check, FlaskConical, GraduationCap, HeartHandshake, Laptop2, MessageCircle, Sparkles, Target } from "lucide-react";
...
export const subjects: { name: string; description: string; icon: LucideIcon }[] = [
  ...
  { name: "Matières de spécialité", description: "Approfondir et exceller dans votre filière.", icon: Sparkles },
];
